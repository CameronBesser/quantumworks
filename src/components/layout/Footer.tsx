  ...
  <footer className="bg-dark-100 border-t border-white/10">
    <div className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
      <div>
        ...
        <p className="text-gray-400 text-sm">Building AI, Cyber, and Software Applications for Government.</p>
      </div>
      <div>
      ...
      <div>
        ...
        <div className="flex space-x-4">
          <a href="#" className="text-gray-400 hover:text-accent-blue transition"><FaLinkedin size={22} /></a>
          <a href="#" className="text-gray-400 hover:text-accent-blue transition"><FaTwitter size={22} /></a>
          <a href="#" className="text-gray-400 hover:text-accent-blue transition"><FaEnvelope size={22} /></a>
        </div>
      </div>
    </div>
